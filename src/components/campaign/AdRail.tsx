...
const AdRail = () => {
  ...
  return (
    <>
      <div className="fixed inset-x-0 top-14 z-[60] bg-background/95 py-2 pt-[calc(0.5rem+env(safe-area-inset-top))] backdrop-blur md:top-16 lg:hidden">
        <AdBanner />
      </div>
      <div className="fixed inset-x-0 bottom-[calc(3.5rem+env(safe-area-inset-bottom))] z-[60] bg-background/95 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] backdrop-blur lg:hidden">
        <AdBanner reverse />
      </div>
